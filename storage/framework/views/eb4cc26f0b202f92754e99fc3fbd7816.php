...
<section class="bg-primary text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl md:text-4xl font-bold mb-4">All Articles</h1>
        <p class="text-gray-300 text-lg">Browse our complete collection of insights for martial arts school owners.</p>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tryamartialart\resources\views/articles.blade.php ENDPATH**/ ?>