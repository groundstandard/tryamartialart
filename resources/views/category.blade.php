...
<section class="bg-primary text-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl md:text-4xl font-bold mb-4">{{ $category }}</h1>
        <p class="text-gray-300 text-lg">Browse all articles in the {{ $category }} category.</p>
    </div>
</section>
...
<section class="bg-white border-b sticky top-16 z-40">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex flex-wrap gap-2">
            ...
            <a 
                href="{{ route('category', strtolower($cat)) }}" 
...
<section class="py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center py-12">
            ...
            <a href="{{ route('articles') }}" class="inline-block mt-4 text-secondary hover:text-secondary-600 font-medium">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-2xl md:text-3xl font-bold text-primary mb-4">
                Want More {{ $category }} Insights?
            </h2>
            <p class="text-primary/80 mb-8">
                Subscribe to get the latest {{ strtolower($category) }} articles delivered straight to your inbox.
            </p>
