...
<section class="py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-10">
            ...
            <a href="{{ route('articles') }}" class="text-secondary hover:text-secondary-600 font-medium transition-colors">
                View All →
            </a>
        </div>
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
                <span class="text-lg font-semibold text-primary group-hover:text-white">{{ $category }}</span>
            </a>
            @endforeach
        </div>
    </div>
