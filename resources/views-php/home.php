...
<section class="py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-10">
            ...
            <a href="/articles" class="text-secondary hover:text-secondary-600 font-medium transition-colors">
                View All →
            </a>
        </div>
...
<section class="py-16 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <a 
                href="/category/<?= strtolower(htmlspecialchars($category)) ?>" 
                class="p-6 bg-gray-50 rounded-xl text-center hover:bg-secondary hover:text-white transition-colors duration-200 group"
            >
                <span class="text-lg font-semibold text-primary group-hover:text-white"><?= htmlspecialchars($category) ?></span>
            </a>
            <?php endforeach; ?>
        </div>
    </div>
